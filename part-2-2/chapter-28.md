...
![그림 28-1!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/picture-28-1.png?raw=true)
...
![표 28-1!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/chart-28-1.png?raw=true)

![그림 28-2!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/picture-28-2.png?raw=true)
...
![그림 28-3!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/picture-28-3.png?raw=true)

![표 28-2!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/chart-28-2.png?raw=true)
...
![그림 28-4!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/picture-28-4.png?raw=true)

![표 28-3!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/chart-28-3.png?raw=true)
...
![표 28-4!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/chart-28-4.png?raw=true)

## IP NAT 호환성 문제와 특수처리 요구사항

![그림 28-5!](https://github.com/nccho/study-tcp-ip/blob/main/resources/chapter-28/picture-28-5.png?raw=true)

IP 주소가 IP 영역에 속하기는 하지만, 네트워크 계층과 상위 계층의 기타 프로토콜에 의해 실제로 쓰이고 있다는 것이다.
NAT는 IP 데이터그램의 IP 주소를 변경한 뒤, 때때로 다른 여러 헤더와 페이로드의 주소까지 함께 수정할 필요가 있다.
이러한 호환성 문제는 NAT가 이론상으로 네트워크 계층의 IP 수준에서만 동작하지만, 실제로는 NAT 라우터가 훨씬 많은 프로토콜을 인지해야 하고 필요한 특수 기능을 수행해야 한다는 것을 의미한다.
그리고 이러한 기능이 NAT 라우터에 추가된다고 하더라도, 일부 애플리케이션은 NAT 환겨에서 제대로 동작하지 않는다. 주요 문제점은 아래와 같다.
...
대부분의 NAT 구현의 최소한 이들 문제 중 일부를 고려하고 있다. 물론 많은 NAT는 FTP와 같은 유명 애플리케이션을 지원한다. 그렇지 않으면 아무도 NAT를 사용하지 않을 것이기 때문이다. 하지만 동작하지 않는 애플리케이션도 존재한다. NAT의 멋진 해결책은 특수 처리를 요하는 상황을 많이 많들지 않는 것이다.